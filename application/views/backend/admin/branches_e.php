 ...
 <?php
    $branch = $this->db->get_where('branches', array('id' => $branch_id))->row_array();
    ?>
             ...
             <div class="col-12 col-md-12 ml-4">
                 <div class="card">
                     ...
                     <div class="card-content">
                         <div class="card-body">
                             <form id="branches_u_title" action="<?php echo site_url('admin/branches/update'); ?>" method="POST" enctype="multipart/form-data" class="form form-horizontal">
                                 <input type="hidden" name="id" id="id" value="<?= $branch['id']; ?>" readonly>
                                 <div class="form-body">
                                     <div class="row">
                                         <div class="col-md-4">
                                         ...
                                         <div class="col-md-8 form-group">
                                             <input type="text" id="branche_title" class="form-control" name="branch_name" placeholder="branch Name" value="<?= $branch['name']; ?>" required>
                                         </div>
                                         <div class="col-md-4">
                                             <label>Description</label>
                                         </div>
                                         <div class="col-md-8 form-group">
                                             <textarea name="branch_desc" id="default" cols="30" rows="10"><?= $branch['description']; ?></textarea>
                                         </div>
                                         <div class="col-md-4">
                                             <label>Link</label>
                                         </div>
                                         <div class="col-md-8 form-group">
                                             <input type="url" id="first-name" class="form-control" name="branch_url" placeholder="Url" value="<?= $branch['link']; ?>">
                                         </div>
                                         <div class="col-md-4">
                                             <label>Image</label>
                                         </div>
                                         <div class="col-md-8 form-group">
                                             <?php if ($branch['image'] != "") { ?>
                                                 <img src="<?= site_url($branch['image']); ?>" alt="Shiroor Math" style="width:100%;height:100%" id="preview_img">
                                                 <br>
                                             <?php } else { ?>
