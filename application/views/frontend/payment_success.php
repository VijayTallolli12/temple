        ...
        <div class="sigma_box pb-0 m-0">
            <div class="row">
                <div style="text-align:center;">
                    <i class="far fa-check-circle" style="font-size: 100px;color: greenyellow;"></i>
                    <div>
                        <p class="mb-0" style="font-size: 50px;">Payment Successfull</p>
                        <p style="font-size: 20px;">Your Transaction Id is <?= $transaction_id ?></p>
                    </div>
                    <div class="pb-4">
