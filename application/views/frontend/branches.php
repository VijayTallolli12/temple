 ...
 <!-- partial -->
 <section class="section sigma_post-single">
     <div class="container">
         <div class="row">
             <div class="col-12">
                 <div class="entry-content">
                     <?php
                        ...
                        ?>
                             <div class="sigma_volunteer-detail mb-2">
                                 <div class="row">
                                     <div class="col-lg-12">
                                         <div class="sigma_volunteer-detail-inner mt-5 mt-lg-0 ps-0">
                                     ...
                                     <div class="col">
                                         <?php if ($value['image'] != "") { ?>
                                             <div class="clearfix">
                                                 <img class="col-md-5 p-2 ms-md-3 rounded float-sm-start" src="<?= site_url($value['image']); ?>" class="mb-0" alt="volunteer">
                                                 <div class="d-inline ">
                                                     <?= $value['description']; ?>
                                                 </div>
                                             </div>
