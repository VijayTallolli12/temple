(() => {
            ...
            750: () => {
                ...
                var o = function() {
                        ...
                        return r = o, (n = [{
                            ...
                            value: function() {
                                var e = this;
                                document.querySelectorAll(".burger-btn").forEach((function(t) { return t.addEventListener("click", e.toggle.bind(e)) })), document.querySelectorAll(".sidebar-hide").forEach((function(t) { return t.addEventListener("click", e.toggle.bind(e)) })), window.addEventListener("resize", this.onResize.bind(this));
                                for (var t = document.querySelectorAll(".sidebar-item.has-sub"), o = function() {
                                        ...
                                        t[r].querySelector(".sidebar-link").addEventListener("click", (function(t) {
                                            ...
                                            o.classList.contains("active") && (o.style.display = "block"), "none" == o.style.display ? o.classList.add("active") : o.classList.remove("active"),
                                                function(e, t, o) { 0 === e.clientHeight ? i(e, t, o, !0) : i(e, t, o) }(o, 300)
                                        }))
                                    }, r = 0; r < t.length; r++) o();
    ...
    function o(e) { var r = i[e]; if (void 0 !== r) return r.exports; var n = i[e] = { exports: {} }; return t[e](n, n.exports, o), n.exports }
    o.m = t, e = [], o.O = (t, i, r, n) => {
        if (!i) {
            var a = 1 / 0;
        ...
        e[d] = [i, r, n]
    }, o.n = e => { var t = e && e.__esModule ? () => e.default : () => e; return o.d(t, { a: t }), t }, o.d = (e, t) => { for (var i in t) o.o(t, i) && !o.o(e, i) && Object.defineProperty(e, i, { enumerable: !0, get: t[i] }) }, o.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), (() => {
