document.getElementById('error_title').addEventListener('click', (e) => {
    Swal.fire({
        icon: "error",
        title: "Title Is Already Present"
    })
})
document.getElementById('check_validate_blogs').addEventListener('click', (e) => {
    Swal.fire({
        icon: "warning",
        title: "Please Insert Blog Description,Images and Select Category"
    })
})
document.getElementById('desc_validation').addEventListener('click', (e) => {
    Swal.fire({
        icon: "warning",
...
document.getElementById('gallery_validation').addEventListener('click', (e) => {
    Swal.fire({
        icon: "warning",
...
document.getElementById('change_password_alert').addEventListener('click', (e) => {
    Swal.fire({
        icon: "warning",
        title: "Your New Password and Re Enterd New Password Is not Same"
    })
})
